...
if(isset($_POST["titre"])){
    ...
    header('Location: info-offre-pro.php');
    exit();
}
    ...
    */
    ...
    $query_rueoffre = "SELECT rueoffre FROM _offre
                    WHERE idoffre = '$idoffre'";
    ...
    $query_ville = "SELECT villeoffre FROM _offre
                    WHERE idoffre = '$idoffre'";
    ...
    $query_codepostal = "SELECT codepostaloffre FROM _offre
                        WHERE idoffre = '$idoffre'";
    ...
    /*$query_telephone = "SELECT telephone FROM _offre
    ...
    /*$query_denomination = "SELECT denomination FROM _offre
    ...
    /*$query_IBAN = "SELECT IBAN FROM _offre
    ...
    $query_resume = "SELECT resume FROM _offre
    ...
    /*
    $query_description = "SELECT description FROM _offre
                    WHERE _offre.idoffre = '$idoffre'";
    ...
    */
    ...
    /*$query_image = "SELECT urlversimage FROM _offre
            ...
            <div class="element_form">
                ...
                <div class="row-form">
                    ...
                    <select name="categorie" id="categorie">
                        <option value="activite" <?php //if(!strcmp($select_categorie,"activite")) echo "selected"?>>Activité</option>
                        <option value="restauration" <?php //if(!strcmp($select_categorie,"restauration")) echo "selected"?>>Réstauration</option>
                        <option value="visite" <?php //if(!strcmp($select_categorie,"visite")) echo "selected"?>>Visite</option>
                        <option value="parc_attractions" <?php //if(!strcmp($select_categorie,"parc_attraction")) echo "selected"?>>Parc d'attractions</option>
                        <option value="spectacle" <?php //if(!strcmp($select_categorie,"spectacle")) echo "selected"?>>Spectacle</option>
                    </select>
                </div>
            </div>
