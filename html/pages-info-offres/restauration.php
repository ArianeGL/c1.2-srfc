            ...
            <div class="info">
                <table class="meal-table">
                    ...
                    <tr>
                        ...
                        <td><?php if ($breakfast) echo "OUI"; else echo "NON" ?></td>
                    </tr>
                    <tr>
                        <td>Déjeuner</td>
                        <td><?php if ($lunch) echo "OUI"; else echo "NON" ?></td>
                    </tr>
                    <tr>
                        <td>Dîner</td>
                        <td><?php if ($dinner) echo "OUI"; else echo "NON" ?></td>
                    </tr>
                    <tr>
                        <td>Boissons</td>
                        <td><?php if ($drinks) echo "OUI"; else echo "NON" ?></td>
                    </tr>
                    <tr>
                        <td>Brunch</td>
                        <td><?php if ($brunch) echo "OUI"; else echo "NON" ?></td>
                    </tr>
                </table>
